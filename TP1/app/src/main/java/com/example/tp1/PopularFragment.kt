...
/**
 * This fragment displays the posters of popular movies
 */
...
class PopularFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        // Call the service to get the popular movies
        apiService.getPopularMovies("c65dcc82ce82ef76b1b8afb960b54a35")?.enqueue(object :
            Callback<MovieList?> {
            override fun onResponse(call: Call<MovieList?>?, response: Response<MovieList?>) {
                ...
                var rvMovie : RecyclerView? = view?.findViewById(R.id.rvMoviesPopular)
